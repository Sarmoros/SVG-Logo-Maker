...
class Triangle extends Shapes {
    render() {
        return `<polygon points="50,10 10,90 90,90" stroke="black" stroke-width="0" fill="${this.color}" />`
    }
}

class Square extends Shapes {  
    render() {
        return `<rect x="10" y="10" width="80" height="80" stroke="black" stroke-width="0" fill="${this.color}" />`
    }
}
